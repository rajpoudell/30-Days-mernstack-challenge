...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Hero Section */}
      <section className="bg-purple-100 text-white">
        <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/login" className="mt-8 inline-block bg-white text-blue-600 py-3 px-5 rounded-lg shadow-md hover:bg-red-700">
            Get Started
          </Link>
        </div>
      </section>
